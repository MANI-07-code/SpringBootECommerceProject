...
import com.mani.ecommerce.config.AppConstants;
...
import com.mani.ecommerce.service.ProductService;
...
public class ProductController {
    ...
    private ResponseEntity<ProductDTO> addProduct(@Valid @RequestBody ProductDTO product,
    ...
    public ResponseEntity<ProductResponse> getProductsByCategory(@PathVariable Long categoryId, @RequestParam(name = "pageNumber",defaultValue = AppConstants.PAGE_NUMBER,required = false) Integer pageNumber,
                                                                 ...
                                                                 @RequestParam(name = "sortBy",defaultValue = AppConstants.SORT_CATEGORIES_BY,required = false) String sortBy,
                                                                 @RequestParam(name = "sortOrder",defaultValue = AppConstants.SORT_DIR,required = false) String sortOrder){
        ProductResponse productsByCategory = productService.getProductsByCategory(categoryId,pageNumber,pageSize,sortBy,sortOrder);
